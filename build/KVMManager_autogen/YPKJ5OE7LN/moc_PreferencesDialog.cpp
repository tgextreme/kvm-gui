...
static constexpr auto qt_meta_stringdata_ZN17PreferencesDialogE = QtMocHelpers::stringData(
    "PreferencesDialog",
...
Q_CONSTINIT static const uint qt_meta_data_ZN17PreferencesDialogE[] = {
...
Q_CONSTINIT const QMetaObject PreferencesDialog::staticMetaObject = { {
    ...
    qt_meta_stringdata_ZN17PreferencesDialogE.offsetsAndSizes,
    qt_meta_data_ZN17PreferencesDialogE,
    qt_static_metacall,
    nullptr,
    qt_incomplete_metaTypeArray<qt_meta_tag_ZN17PreferencesDialogE_t,
        // Q_OBJECT / Q_GADGET
...
void *PreferencesDialog::qt_metacast(const char *_clname)
{
    ...
    if (!strcmp(_clname, qt_meta_stringdata_ZN17PreferencesDialogE.stringdata0))
